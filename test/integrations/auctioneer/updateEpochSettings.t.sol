...
contract Auctioneer_UpdateEpochSettings_Integrations_Test is Integrations_Test {
    ...
    function test_Auctioneer_UpdateEpochSettings() external callIsAuthorized(true) {
    ...
    function test_Auctioneer_UpdateEpochSettings_RevertWhen_CallerNotAuthorized() external callIsAuthorized(false) {
        vm.expectRevert(abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, users.hacker.addr));
        auctioneer.updateEpochSettings(newEpochDuration, newInitPrice, newPriceMultiplier, newMinInitPrice);
    }

    function test_Auctioneer_UpdateEpochSettings_RevertWhen_InitPriceBelowMin() external callIsAuthorized(true) {
    ...
    function test_Auctioneer_UpdateEpochSettings_RevertWhen_EpochDurationBelowMin() external callIsAuthorized(true) {
    ...
    function test_Auctioneer_UpdateEpochSettings_RevertWhen_EpochDurationExceedsMax()
        external
    ...
    function test_Auctioneer_UpdateEpochSettings_RevertWhen_PriceMultiplierBelowMin()
        external
        callIsAuthorized(true)
    {
    ...
    function test_Auctioneer_UpdateEpochSettings_RevertWhen_MinInitPriceBelowMin() external callIsAuthorized(true) {
