...
contract TimeLockPenaltyERC20_CancelWithdrawalRequest_Integrations_Test is Integrations_Test {
    ...
    function test_TimeLockPenaltyERC20_CancelWithdrawalRequest() external requestOneWithdraw {
        vm.expectEmit(address(timeLockPenaltyERC20));
        emit TimeLockPenaltyERC20.CancelledWithdrawalRequest(0, users.alice.addr, INITIAL_BALANCE);
        timeLockPenaltyERC20.cancelWithdrawalRequest(0);
    ...
    function test_TimeLockPenaltyERC20_CancelMultipleWithdrawalRequest() external requestMultiWithdraw {
        uint256[] memory ids = new uint256[](3);
        ids[0] = 0;
        ids[1] = 2;
        ids[2] = 4;
        timeLockPenaltyERC20.cancelMultipleWithdrawalRequests(ids);
    ...
    function test_TimeLockPenaltyERC20_CancelWithdrawalRequest_RevertWhen_WrongRequestStatus() external {
        vm.expectRevert(abi.encodeWithSelector(TimeLockPenaltyERC20.CannotCancelWithdrawalRequest.selector, 0));
        timeLockPenaltyERC20.cancelWithdrawalRequest(0);
    }
}
